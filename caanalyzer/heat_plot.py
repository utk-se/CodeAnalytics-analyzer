...
'''
Provide a repo path and create a frequency map for an entire repo.
Note that this is more of an example, as they should be aggregated
...
'''
def plot_heatmap_from_frequency(nd_array, ):
    # y contains line numbers
    # x contains column numbers
    ax = plt.gca()
